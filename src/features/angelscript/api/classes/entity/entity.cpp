...
template<typename T>
void SetProp(CBaseEntity* ent, const std::string& className, const std::string& prop, T value)
{
	if (!ent) return;
...
{
	if (ent == nullptr) return "Invalid Entity";
...
void Entity_RegisterClass(asIScriptEngine* engine)
{
	...
	engine->RegisterObjectBehaviour(ENTITY_CLASSNAME, asBEHAVE_ADDREF, "void f()", asFUNCTION(Entity_AddRef), asCALL_CDECL_OBJLAST);
	engine->RegisterObjectBehaviour(ENTITY_CLASSNAME, asBEHAVE_RELEASE, "void f()", asFUNCTION(Entity_Release), asCALL_CDECL_OBJLAST);
	...
	engine->RegisterObjectMethod(ENTITY_CLASSNAME, "Vector EstimateAbsVelocity() const", asMETHOD(CBaseEntity, EstimateAbsVelocity), asCALL_THISCALL);
	...
	engine->RegisterObjectMethod(ENTITY_CLASSNAME, "Vector GetPropVector(const string &in className, const string &in propName)", asFUNCTION(GetPropVector), asCALL_CDECL_OBJFIRST);
	...
	engine->RegisterObjectMethod(ENTITY_CLASSNAME, "void SetPropVector(const string &in className, const string &in propName, Vector value)", asFUNCTION(SetPropVector), asCALL_CDECL_OBJFIRST);
	...
	engine->RegisterObjectMethod(ENTITY_CLASSNAME, "Vector GetAbsOrigin()", asFUNCTION(GetAbsOrigin), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod(ENTITY_CLASSNAME, "Vector GetAbsAngles()", asFUNCTION(GetAbsAngles), asCALL_CDECL_OBJFIRST);
