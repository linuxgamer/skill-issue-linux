...
void ViewSetup_RegisterClass(asIScriptEngine* engine)
{
	...
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "int m_nUnscaledWidth", asOFFSET(CViewSetup, m_nUnscaledWidth));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "int height", asOFFSET(CViewSetup, height));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "int m_nUnscaledHeight", asOFFSET(CViewSetup, m_nUnscaledHeight));
	...
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "bool m_bRenderToSubrectOfLargerScreen", asOFFSET(CViewSetup, m_bRenderToSubrectOfLargerScreen));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "float m_flAspectRatio", asOFFSET(CViewSetup, m_flAspectRatio));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "bool m_bOffCenter", asOFFSET(CViewSetup, m_bOffCenter));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "float m_flOffCenterTop", asOFFSET(CViewSetup, m_flOffCenterTop));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "float m_flOffCenterBottom", asOFFSET(CViewSetup, m_flOffCenterBottom));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "float m_flOffCenterLeft", asOFFSET(CViewSetup, m_flOffCenterLeft));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "float m_flOffCenterRight", asOFFSET(CViewSetup, m_flOffCenterRight));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "bool m_bDoBloomAndToneMapping", asOFFSET(CViewSetup, m_bDoBloomAndToneMapping));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "bool m_bCacheFullSceneState", asOFFSET(CViewSetup, m_bCacheFullSceneState));
	engine->RegisterObjectProperty(VIEWSETUP_CLASSNAME, "bool m_bViewToProjectionOverride", asOFFSET(CViewSetup, m_bViewToProjectionOverride));
}