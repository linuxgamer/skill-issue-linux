...
void Texture_RegisterClass(asIScriptEngine* engine)
{
	...
	engine->RegisterObjectMethod(TEXTURE_CLASSNAME, "int GetActualWidth()", asFUNCTION(GetActualWidth), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod(TEXTURE_CLASSNAME, "int GetActualHeight()", asFUNCTION(GetActualHeight), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod(TEXTURE_CLASSNAME, "bool IsTranslucent()", asFUNCTION(IsTranslucent), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod(TEXTURE_CLASSNAME, "bool IsRenderTarget()", asFUNCTION(IsRenderTarget), asCALL_CDECL_OBJFIRST);
}