...
void Enums_Register(asIScriptEngine *engine)
{
	...
	engine->RegisterEnum("BindMode");
	engine->RegisterEnumValue("BindMode", "Off", static_cast<int>(HotkeyMode::Off));
	engine->RegisterEnumValue("BindMode", "Hold", static_cast<int>(HotkeyMode::Hold));
	engine->RegisterEnumValue("BindMode", "Toggle", static_cast<int>(HotkeyMode::Toggle));
	engine->RegisterEnumValue("BindMode", "HoldOff", static_cast<int>(HotkeyMode::HoldOff));
	engine->RegisterEnumValue("BindMode", "Always", static_cast<int>(HotkeyMode::Always));

	engine->RegisterEnum("ImGuiKey");
	engine->RegisterEnumValue("ImGuiKey", "NamedKey_BEGIN", ImGuiKey_NamedKey_BEGIN);
	engine->RegisterEnumValue("ImGuiKey", "Tab", ImGuiKey_Tab);
	engine->RegisterEnumValue("ImGuiKey", "LeftArrow", ImGuiKey_LeftArrow);
	engine->RegisterEnumValue("ImGuiKey", "RightArrow", ImGuiKey_RightArrow);
	engine->RegisterEnumValue("ImGuiKey", "UpArrow", ImGuiKey_UpArrow);
	engine->RegisterEnumValue("ImGuiKey", "DownArrow", ImGuiKey_DownArrow);
	engine->RegisterEnumValue("ImGuiKey", "PageUp", ImGuiKey_PageUp);
	engine->RegisterEnumValue("ImGuiKey", "PageDown", ImGuiKey_PageDown);
	engine->RegisterEnumValue("ImGuiKey", "Home", ImGuiKey_Home);
	engine->RegisterEnumValue("ImGuiKey", "End", ImGuiKey_End);
	engine->RegisterEnumValue("ImGuiKey", "Insert", ImGuiKey_Insert);
	engine->RegisterEnumValue("ImGuiKey", "Delete", ImGuiKey_Delete);
	engine->RegisterEnumValue("ImGuiKey", "Backspace", ImGuiKey_Backspace);
	engine->RegisterEnumValue("ImGuiKey", "Space", ImGuiKey_Space);
	engine->RegisterEnumValue("ImGuiKey", "Enter", ImGuiKey_Enter);
	engine->RegisterEnumValue("ImGuiKey", "Escape", ImGuiKey_Escape);
	engine->RegisterEnumValue("ImGuiKey", "LeftCtrl", ImGuiKey_LeftCtrl);
	engine->RegisterEnumValue("ImGuiKey", "LeftShift", ImGuiKey_LeftShift);
	engine->RegisterEnumValue("ImGuiKey", "LeftAlt", ImGuiKey_LeftAlt);
	engine->RegisterEnumValue("ImGuiKey", "LeftSuper", ImGuiKey_LeftSuper);
	engine->RegisterEnumValue("ImGuiKey", "RightCtrl", ImGuiKey_RightCtrl);
	engine->RegisterEnumValue("ImGuiKey", "RightShift", ImGuiKey_RightShift);
	engine->RegisterEnumValue("ImGuiKey", "RightAlt", ImGuiKey_RightAlt);
	engine->RegisterEnumValue("ImGuiKey", "RightSuper", ImGuiKey_RightSuper);
	engine->RegisterEnumValue("ImGuiKey", "Menu", ImGuiKey_Menu);
	engine->RegisterEnumValue("ImGuiKey", "Num0", ImGuiKey_0);
	engine->RegisterEnumValue("ImGuiKey", "Num1", ImGuiKey_1);
	engine->RegisterEnumValue("ImGuiKey", "Num2", ImGuiKey_2);
	engine->RegisterEnumValue("ImGuiKey", "Num3", ImGuiKey_3);
	engine->RegisterEnumValue("ImGuiKey", "Num4", ImGuiKey_4);
	engine->RegisterEnumValue("ImGuiKey", "Num5", ImGuiKey_5);
	engine->RegisterEnumValue("ImGuiKey", "Num6", ImGuiKey_6);
	engine->RegisterEnumValue("ImGuiKey", "Num7", ImGuiKey_7);
	engine->RegisterEnumValue("ImGuiKey", "Num8", ImGuiKey_8);
	engine->RegisterEnumValue("ImGuiKey", "Num9", ImGuiKey_9);
	engine->RegisterEnumValue("ImGuiKey", "A", ImGuiKey_A);
	engine->RegisterEnumValue("ImGuiKey", "B", ImGuiKey_B);
	engine->RegisterEnumValue("ImGuiKey", "C", ImGuiKey_C);
	engine->RegisterEnumValue("ImGuiKey", "D", ImGuiKey_D);
	engine->RegisterEnumValue("ImGuiKey", "E", ImGuiKey_E);
	engine->RegisterEnumValue("ImGuiKey", "F", ImGuiKey_F);
	engine->RegisterEnumValue("ImGuiKey", "G", ImGuiKey_G);
	engine->RegisterEnumValue("ImGuiKey", "H", ImGuiKey_H);
	engine->RegisterEnumValue("ImGuiKey", "I", ImGuiKey_I);
	engine->RegisterEnumValue("ImGuiKey", "J", ImGuiKey_J);
	engine->RegisterEnumValue("ImGuiKey", "K", ImGuiKey_K);
	engine->RegisterEnumValue("ImGuiKey", "L", ImGuiKey_L);
	engine->RegisterEnumValue("ImGuiKey", "M", ImGuiKey_M);
	engine->RegisterEnumValue("ImGuiKey", "N", ImGuiKey_N);
	engine->RegisterEnumValue("ImGuiKey", "O", ImGuiKey_O);
	engine->RegisterEnumValue("ImGuiKey", "P", ImGuiKey_P);
	engine->RegisterEnumValue("ImGuiKey", "Q", ImGuiKey_Q);
	engine->RegisterEnumValue("ImGuiKey", "R", ImGuiKey_R);
	engine->RegisterEnumValue("ImGuiKey", "S", ImGuiKey_S);
	engine->RegisterEnumValue("ImGuiKey", "T", ImGuiKey_T);
	engine->RegisterEnumValue("ImGuiKey", "U", ImGuiKey_U);
	engine->RegisterEnumValue("ImGuiKey", "V", ImGuiKey_V);
	engine->RegisterEnumValue("ImGuiKey", "W", ImGuiKey_W);
	engine->RegisterEnumValue("ImGuiKey", "X", ImGuiKey_X);
	engine->RegisterEnumValue("ImGuiKey", "Y", ImGuiKey_Y);
	engine->RegisterEnumValue("ImGuiKey", "Z", ImGuiKey_Z);
	engine->RegisterEnumValue("ImGuiKey", "F1", ImGuiKey_F1);
	engine->RegisterEnumValue("ImGuiKey", "F2", ImGuiKey_F2);
	engine->RegisterEnumValue("ImGuiKey", "F3", ImGuiKey_F3);
	engine->RegisterEnumValue("ImGuiKey", "F4", ImGuiKey_F4);
	engine->RegisterEnumValue("ImGuiKey", "F5", ImGuiKey_F5);
	engine->RegisterEnumValue("ImGuiKey", "F6", ImGuiKey_F6);
	engine->RegisterEnumValue("ImGuiKey", "F7", ImGuiKey_F7);
	engine->RegisterEnumValue("ImGuiKey", "F8", ImGuiKey_F8);
	engine->RegisterEnumValue("ImGuiKey", "F9", ImGuiKey_F9);
	engine->RegisterEnumValue("ImGuiKey", "F10", ImGuiKey_F10);
	engine->RegisterEnumValue("ImGuiKey", "F11", ImGuiKey_F11);
	engine->RegisterEnumValue("ImGuiKey", "F12", ImGuiKey_F12);
	engine->RegisterEnumValue("ImGuiKey", "F13", ImGuiKey_F13);
	engine->RegisterEnumValue("ImGuiKey", "F14", ImGuiKey_F14);
	engine->RegisterEnumValue("ImGuiKey", "F15", ImGuiKey_F15);
	engine->RegisterEnumValue("ImGuiKey", "F16", ImGuiKey_F16);
	engine->RegisterEnumValue("ImGuiKey", "F17", ImGuiKey_F17);
	engine->RegisterEnumValue("ImGuiKey", "F18", ImGuiKey_F18);
	engine->RegisterEnumValue("ImGuiKey", "F19", ImGuiKey_F19);
	engine->RegisterEnumValue("ImGuiKey", "F20", ImGuiKey_F20);
	engine->RegisterEnumValue("ImGuiKey", "F21", ImGuiKey_F21);
	engine->RegisterEnumValue("ImGuiKey", "F22", ImGuiKey_F22);
	engine->RegisterEnumValue("ImGuiKey", "F23", ImGuiKey_F23);
	engine->RegisterEnumValue("ImGuiKey", "F24", ImGuiKey_F24);
	engine->RegisterEnumValue("ImGuiKey", "Apostrophe", ImGuiKey_Apostrophe);
	engine->RegisterEnumValue("ImGuiKey", "Comma", ImGuiKey_Comma);
	engine->RegisterEnumValue("ImGuiKey", "Minus", ImGuiKey_Minus);
	engine->RegisterEnumValue("ImGuiKey", "Period", ImGuiKey_Period);
	engine->RegisterEnumValue("ImGuiKey", "Slash", ImGuiKey_Slash);
	engine->RegisterEnumValue("ImGuiKey", "Semicolon", ImGuiKey_Semicolon);
	engine->RegisterEnumValue("ImGuiKey", "Equal", ImGuiKey_Equal);
	engine->RegisterEnumValue("ImGuiKey", "LeftBracket", ImGuiKey_LeftBracket);
	engine->RegisterEnumValue("ImGuiKey", "Backslash", ImGuiKey_Backslash);
	engine->RegisterEnumValue("ImGuiKey", "RightBracket", ImGuiKey_RightBracket);
	engine->RegisterEnumValue("ImGuiKey", "GraveAccent", ImGuiKey_GraveAccent);
	engine->RegisterEnumValue("ImGuiKey", "CapsLock", ImGuiKey_CapsLock);
	engine->RegisterEnumValue("ImGuiKey", "ScrollLock", ImGuiKey_ScrollLock);
	engine->RegisterEnumValue("ImGuiKey", "NumLock", ImGuiKey_NumLock);
	engine->RegisterEnumValue("ImGuiKey", "PrintScreen", ImGuiKey_PrintScreen);
	engine->RegisterEnumValue("ImGuiKey", "Pause", ImGuiKey_Pause);
	engine->RegisterEnumValue("ImGuiKey", "Keypad0", ImGuiKey_Keypad0);
	engine->RegisterEnumValue("ImGuiKey", "Keypad1", ImGuiKey_Keypad1);
	engine->RegisterEnumValue("ImGuiKey", "Keypad2", ImGuiKey_Keypad2);
	engine->RegisterEnumValue("ImGuiKey", "Keypad3", ImGuiKey_Keypad3);
	engine->RegisterEnumValue("ImGuiKey", "Keypad4", ImGuiKey_Keypad4);
	engine->RegisterEnumValue("ImGuiKey", "Keypad5", ImGuiKey_Keypad5);
	engine->RegisterEnumValue("ImGuiKey", "Keypad6", ImGuiKey_Keypad6);
	engine->RegisterEnumValue("ImGuiKey", "Keypad7", ImGuiKey_Keypad7);
	engine->RegisterEnumValue("ImGuiKey", "Keypad8", ImGuiKey_Keypad8);
	engine->RegisterEnumValue("ImGuiKey", "Keypad9", ImGuiKey_Keypad9);
	engine->RegisterEnumValue("ImGuiKey", "KeypadDecimal", ImGuiKey_KeypadDecimal);
	engine->RegisterEnumValue("ImGuiKey", "KeypadDivide", ImGuiKey_KeypadDivide);
	engine->RegisterEnumValue("ImGuiKey", "KeypadMultiply", ImGuiKey_KeypadMultiply);
	engine->RegisterEnumValue("ImGuiKey", "KeypadSubtract", ImGuiKey_KeypadSubtract);
	engine->RegisterEnumValue("ImGuiKey", "KeypadAdd", ImGuiKey_KeypadAdd);
	engine->RegisterEnumValue("ImGuiKey", "KeypadEnter", ImGuiKey_KeypadEnter);
	engine->RegisterEnumValue("ImGuiKey", "KeypadEqual", ImGuiKey_KeypadEqual);
	engine->RegisterEnumValue("ImGuiKey", "AppBack", ImGuiKey_AppBack);
	engine->RegisterEnumValue("ImGuiKey", "AppForward", ImGuiKey_AppForward);
	engine->RegisterEnumValue("ImGuiKey", "Oem102", ImGuiKey_Oem102);
	engine->RegisterEnumValue("ImGuiKey", "GamepadStart", ImGuiKey_GamepadStart);
	engine->RegisterEnumValue("ImGuiKey", "GamepadBack", ImGuiKey_GamepadBack);
	engine->RegisterEnumValue("ImGuiKey", "GamepadFaceLeft", ImGuiKey_GamepadFaceLeft);
	engine->RegisterEnumValue("ImGuiKey", "GamepadFaceRight", ImGuiKey_GamepadFaceRight);
	engine->RegisterEnumValue("ImGuiKey", "GamepadFaceUp", ImGuiKey_GamepadFaceUp);
	engine->RegisterEnumValue("ImGuiKey", "GamepadFaceDown", ImGuiKey_GamepadFaceDown);
	engine->RegisterEnumValue("ImGuiKey", "GamepadDpadLeft", ImGuiKey_GamepadDpadLeft);
	engine->RegisterEnumValue("ImGuiKey", "GamepadDpadRight", ImGuiKey_GamepadDpadRight);
	engine->RegisterEnumValue("ImGuiKey", "GamepadDpadUp", ImGuiKey_GamepadDpadUp);
	engine->RegisterEnumValue("ImGuiKey", "GamepadDpadDown", ImGuiKey_GamepadDpadDown);
	engine->RegisterEnumValue("ImGuiKey", "GamepadL1", ImGuiKey_GamepadL1);
	engine->RegisterEnumValue("ImGuiKey", "GamepadR1", ImGuiKey_GamepadR1);
	engine->RegisterEnumValue("ImGuiKey", "GamepadL2", ImGuiKey_GamepadL2);
	engine->RegisterEnumValue("ImGuiKey", "GamepadR2", ImGuiKey_GamepadR2);
	engine->RegisterEnumValue("ImGuiKey", "GamepadL3", ImGuiKey_GamepadL3);
	engine->RegisterEnumValue("ImGuiKey", "GamepadR3", ImGuiKey_GamepadR3);
	engine->RegisterEnumValue("ImGuiKey", "GamepadLStickLeft", ImGuiKey_GamepadLStickLeft);
	engine->RegisterEnumValue("ImGuiKey", "GamepadLStickRight", ImGuiKey_GamepadLStickRight);
	engine->RegisterEnumValue("ImGuiKey", "GamepadLStickUp", ImGuiKey_GamepadLStickUp);
	engine->RegisterEnumValue("ImGuiKey", "GamepadLStickDown", ImGuiKey_GamepadLStickDown);
	engine->RegisterEnumValue("ImGuiKey", "GamepadRStickLeft", ImGuiKey_GamepadRStickLeft);
	engine->RegisterEnumValue("ImGuiKey", "GamepadRStickRight", ImGuiKey_GamepadRStickRight);
	engine->RegisterEnumValue("ImGuiKey", "GamepadRStickUp", ImGuiKey_GamepadRStickUp);
	engine->RegisterEnumValue("ImGuiKey", "GamepadRStickDown", ImGuiKey_GamepadRStickDown);
	engine->RegisterEnumValue("ImGuiKey", "MouseLeft", ImGuiKey_MouseLeft);
	engine->RegisterEnumValue("ImGuiKey", "MouseRight", ImGuiKey_MouseRight);
	engine->RegisterEnumValue("ImGuiKey", "MouseMiddle", ImGuiKey_MouseMiddle);
	engine->RegisterEnumValue("ImGuiKey", "MouseX1", ImGuiKey_MouseX1);
	engine->RegisterEnumValue("ImGuiKey", "MouseX2", ImGuiKey_MouseX2);
	engine->RegisterEnumValue("ImGuiKey", "MouseWheelX", ImGuiKey_MouseWheelX);
	engine->RegisterEnumValue("ImGuiKey", "MouseWheelY", ImGuiKey_MouseWheelY);
	engine->RegisterEnumValue("ImGuiKey", "ReservedForModCtrl", ImGuiKey_ReservedForModCtrl);
	engine->RegisterEnumValue("ImGuiKey", "ReservedForModShift", ImGuiKey_ReservedForModShift);
	engine->RegisterEnumValue("ImGuiKey", "ReservedForModAlt", ImGuiKey_ReservedForModAlt);
	engine->RegisterEnumValue("ImGuiKey", "ReservedForModSuper", ImGuiKey_ReservedForModSuper);
	engine->RegisterEnumValue("ImGuiKey", "NamedKey_END", ImGuiKey_NamedKey_END);
}