...
ADD_SIG(ClientModeShared_FireGameEvent, "client.so", "55 48 89 E5 41 57 41 56 49 89 FE 41 55 41 54 49 89 F4 53 48 8D 35")
...
inline void HookFireGameEvent(void)
{
	...
	detour_init(&firegameevent_ctx, Sigs::ClientModeShared_FireGameEvent.GetPointer(), (void*)&Hooked_FireGameEvent);
