...
inline int Hooked_BaseInterpolatePart1(CBaseEntity* self, float *currentTime, Vector *oldOrigin, QAngle *oldAngles, Vector *oldVel, int *bNoMoreChanges)
{
	...
	if (self == nullptr || currentTime == nullptr || oldOrigin == nullptr || oldAngles == nullptr || oldVel == nullptr || bNoMoreChanges == nullptr)
...
{
	detour_init(&interp_ctx, Sigs::CBaseEntity_BaseInterpolateParte1.GetPointer(), (void*)&Hooked_BaseInterpolatePart1);
