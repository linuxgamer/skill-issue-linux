...
{
	void* original = sigscan_module("client.so", "55 48 89 E5 41 57 41 56 41 55 41 54 49 89 FC 53 48 83 EC 18 8B 97 54 07 00 00");
	detour_init(&ctfwearable_shoulddraw_ctx, original, (void*)&Hooked_CTFWearable_ShouldDraw);
