...
// Vector are exponetial maps (an axis in HL units scaled by a "twist" angle in degrees)
...
public:
	...
	virtual simresult_e	Simulate( IPhysicsMotionController *pController, IPhysicsObject *pObject, float deltaTime, Vector &linear, Vector &angular ) = 0;
};
